...
class Design_9_9_2WayControl extends ActorScript
{
	...
	public var _MovementSound:Sound;
	public var _MovementRandom:Float;
	public var controlLeft:String;
	public var _MovementSound3:Sound;
	public var controlRight:String;
	public var _MovementSound2:Sound;
	...
	public function new(dummy:Int, actor:Actor, dummy2:Engine)
	{
		...
		pressedRight = false;
		nameMap.set("MovementSound", "_MovementSound");
		nameMap.set("MovementRandom", "_MovementRandom");
		_MovementRandom = 0.0;
		nameMap.set("Left Control", "controlLeft");
		nameMap.set("MovementSound3", "_MovementSound3");
		nameMap.set("Right Control", "controlRight");
		nameMap.set("MovementSound2", "_MovementSound2");
