...
class Design_22_22 extends ActorScript
{
	...
	public function _customEvent_whenThisHearstrigger():Void
	{
		if(_Fired)
		{
			...
			_BulletCreated.setFilter([createTintFilter(Utils.getColorRGB(255,51,51), 75/100)]);
	...
	public function new(dummy:Int, actor:Actor, dummy2:Engine)
	{
		...
		_XOffset = 0.0;
		nameMap.set("ShootAnim", "_ShootAnim");
	...
	override public function init()
	{
		...
		addKeyStateListener("space", function(pressed:Bool, released:Bool, list:Array<Dynamic>):Void
		{
			...
			{
				loopSoundOnChannel(getSound(85), 1);
			}
		});
